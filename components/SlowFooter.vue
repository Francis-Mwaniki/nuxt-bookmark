      ...
      <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-4 gap-8 md:grid-cols-8">
          <div class="col-span-2 md:col-span-1">
            <h3 class="md:text-lg font-extrabold text-gray-900 sm:text-md text-sm">
              About Us
            </h3>
            <ul class="low mt-4 space-y-4 font-light">
              <li>
                <NuxtLink
                  class="low font-light hover:underline text-sm md:text-lg sm:text-md text-blue-700"
                  to="/our-story"
                  >Our Story</NuxtLink
                >
              </li>
          ...
          <div class="col-span-2 md:col-span-1">
            <NuxtLink
              to="/Pricing"
              class="md:text-lg font-extrabold text-gray-900 sm:text-md text-sm"
              >Pricing</NuxtLink
            >
            <ul class="low mt-4 space-y-4 font-light">
              <li>
